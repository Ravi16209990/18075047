...
Working files:
--------------
You will be restricted to work with 'logic.py’ and 'knowledge.py'. YOU ARE NOT ALLOWED TO MODIFY ANY CODE WRITTEN OUTSIDE OF '# BEGIN YOUR CODE #' and '# END OF YOUR CODE #' MARKERS. The scorer code we use may depend on some part of that code making any changes to which might hamper your score.
